...
sQuest listQuest[] = {
    ...
    {   eQuestClearDaily3,      @"cleardaily3",     NO, 30, @"Clear daily calcusudoku"},
    ...
    {   eQuestPuzzleShare,      @"puzzleshare",     NO, 30, @"Share a puzzle you played"},
    {   eQuestRecordShare,      @"recordshare",     NO, 30, @"Share your record"},
    ...
    {   eQuestChangeLang,       @"changelang",      NO, 3,  @"Change your language"},
    {   eQuestDoubleTab,        @"doubletab",       NO, 5,  @"Memo mode using double tab"},
    {   eQuestLongTouch,        @"longtouch",       NO, 8,  @"Press and hold a number button in memo mode"},
    {   eQuestAppReview,        @"appreview",       NO, 99, @"Review this app from setting page"},
    {   eQuestChangeName,       @"changename",      NO, 10, @"Change your nickname"},
    {   eQuestCheckRanking,     @"checkranking",    NO, 10, @"Check your ranking after finishing game"},
