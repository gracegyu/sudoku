...
#define MY_INTERSTITIAL_UNIT_ID_IPHONE    (@"ca-app-pub-1077680179839843/8552802791")
#define MY_INTERSTITIAL_UNIT_ID_IPAD      (@"ca-app-pub-1077680179839843/1029535998")
...
#define MY_INTERSTITIAL_UNIT_ID_IPHONE    (@"ca-app-pub-1077680179839843/2506269197")
#define MY_INTERSTITIAL_UNIT_ID_IPAD      (@"ca-app-pub-1077680179839843/3983002395")
...
#define MIN_NAME    3
                                    // server default
#define INTERSTITIALINTERVAL    1   // 2    (once a 2 times)
#define INTERSTITIALRANDOM      1   // 2    (+0 ~ +2)
