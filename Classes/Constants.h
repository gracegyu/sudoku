...
#define MY_HINT_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/5779853912")
#define MY_HINT_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/6300945703")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/7841027507")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/5303204514")
...
#define MY_HINT_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/1515856021")
#define MY_HINT_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/9145389444")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/7270768598")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/4069890185")
...
#define MY_HINT_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/9996648136")
#define MY_HINT_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/6795769726")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/4449164135")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/8037179069")
...
#define MY_HINT_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/1594202485")
#define MY_HINT_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/9005788642")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPHONE        (@"ca-app-pub-1077680179839843/7897454551")
#define MY_CALCCANDI_REWARD_UNIT_ID_IPAD          (@"ca-app-pub-1077680179839843/5654434591")
...
#ifdef DEBUG
#define MY_HINT_REWARD_UNIT_ID       (@"ca-app-pub-3940256099942544/1712485313")
#define MY_CALCCANDI_REWARD_UNIT_ID       (@"ca-app-pub-1077680179839843/7841027507")   // like iphone 
#else
#define MY_HINT_REWARD_UNIT_ID       ((cDeviceType == DEVICETYPE_IPAD) ? MY_HINT_REWARD_UNIT_ID_IPAD : MY_HINT_REWARD_UNIT_ID_IPHONE)
#define MY_CALCCANDI_REWARD_UNIT_ID       ((cDeviceType == DEVICETYPE_IPAD) ? MY_CALCCANDI_REWARD_UNIT_ID_IPAD : MY_CALCCANDI_REWARD_UNIT_ID_IPHONE)
